...
namespace WaveBT_Server
{
    ...
    {
        public static PointPairList list_ecg = new PointPairList();   //ECG显示列表
        private LineItem myCurve_ecg;
        private ClsOscilloscope clsOscilloscop = new ClsOscilloscope();
        ...
        {
            //ZedGraph控件初始化
            this.zedGraphControl1.GraphPane.Title.Text = "心电图";
            ...
            this.zedGraphControl2.GraphPane.Title.Text = "加速度向量模";
            this.zedGraphControl2.GraphPane.XAxis.Title.Text = "时间";
            this.zedGraphControl2.GraphPane.YAxis.Title.Text = "幅度";
            ...
            myCurve_ecg = zedGraphControl1.GraphPane.AddCurve("心电信号",
                list_ecg, Color.Blue, SymbolType.None);
            for (int i = 0; i < 800; i++)
            {
        ...
        //    byte[] InputBuffer_ecg = new byte[128];  //ECG输入缓存
        //    int count = 0;
        //    while (true)
        //    {
        //        while (count < N_buf * 2)
        ...
        //            short y = (short)((InputBuffer_ecg[count] & 0xff) | ((InputBuffer_ecg[count + 1] & 0xff) << 8));
        //            double x = (double)new XDate(DateTime.Now);
        //            list_ecg.Add(x, y);
        //            //判断显示列表的宽度
